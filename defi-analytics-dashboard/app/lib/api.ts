...
// Fetch all revenue data for all wallets
export const fetchAllRevenueData = async (
  startDate: Date, 
  endDate: Date
): Promise<RevenueData[]> => {
  ...
  return fetchRevenueData(startTimestamp, endTimestamp);
};

// Mock data generator for development
export const generateMockRevenueData = (days = 30): RevenueData[] => {
